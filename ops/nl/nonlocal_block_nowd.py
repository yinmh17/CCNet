...
class _NonLocalNd_nowd(nn.Module):
    ...
    def __init__(self, dim, inplanes, planes, downsample, use_gn, lr_mult, use_out, out_bn, whiten_type, weight_init_scale, with_gc, eps):
        ...
        self.reset_weight_and_wd_of_qk()
    ...
    def reset_weight_and_wd_of_qk(self):
...
class NonLocal2d_nowd(_NonLocalNd_nowd):
    def __init__(self, inplanes, planes, downsample=True, use_gn=False, lr_mult=None, use_out=False, out_bn=False, whiten_type=['in_nostd'], weight_init_scale=1.0, with_gc=False, eps=1e-5):
        super(NonLocal2d_nowd, self).__init__(dim=2, inplanes=inplanes, planes=planes, downsample=downsample, use_gn=use_gn, lr_mult=lr_mult, use_out=use_out, out_bn=out_bn, whiten_type=whiten_type, weight_init_scale=weight_init_scale, with_gc=with_gc, eps=eps)
