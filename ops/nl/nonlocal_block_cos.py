...
class _NonLocalNdCos(nn.Module):
    ...
    def __init__(self, dim, inplanes, planes, downsample, use_gn, lr_mult, use_out):
        ...
        super(_NonLocalNdCos, self).__init__()
...
class NonLocal2dCos(_NonLocalNdCos):

    def __init__(self, inplanes, planes, downsample=False, use_gn=False, lr_mult=None, use_out=False):
        super(NonLocal2dCos, self).__init__(dim=2, inplanes=inplanes, planes=planes, downsample=downsample, use_gn=use_gn, lr_mult=lr_mult, use_out=use_out)
